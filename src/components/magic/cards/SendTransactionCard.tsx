...
const SendTransaction = () => {
  ...
  const sendTransaction = useCallback(async () => {
    ...
    if (isEip1559Supported()) {
      ...
      txnParams.maxFeePerGas = feeData.maxFeePerGas ? BigInt(feeData.maxFeePerGas) : undefined;
      txnParams.maxPriorityFeePerGas = feeData.maxPriorityFeePerGas ? BigInt(feeData.maxPriorityFeePerGas) : undefined;
    } else {
      const gasPrice = await web3.eth.getGasPrice();
      txnParams.gasPrice = gasPrice.toString();
    }
